...
(function () {
  ...
  Object.entries(socialMap).forEach(([platform, url]) => {
    if (url) {
      ...
      // Text label links
      $$('.soc a, footer a, .socials a, .social-links a, .ss-socials a').forEach(a => {
      ...
      $$('.soc a, .socials a, .social-links a, .ft-soc a, .ss-socials a').forEach(a => {
  ...
  function buildCheckoutPanel() {
    ...
    panel.innerHTML = `<style>
      #ss-checkout{position:fixed;bottom:0;right:0;width:340px;max-height:90vh;overflow-y:auto;
        background:#fff;color:#0a0a0a;border-radius:18px 18px 0 0;box-shadow:0 -8px 40px rgba(0,0,0,.18);
        z-index:99999;padding:20px;font-family:inherit;display:none;border-top:3px solid #16a34a}
      #ss-checkout *{color:#0a0a0a}
      #ss-checkout h4{font-size:15px;font-weight:700;margin-bottom:14px;display:flex;justify-content:space-between;align-items:center;color:#0a0a0a}
      #ss-cart-items{margin-bottom:12px;max-height:180px;overflow-y:auto}
      .ss-item{display:flex;justify-content:space-between;font-size:13px;padding:6px 0;border-bottom:1px solid #f0f0f0;color:#0a0a0a}
      .ss-item button{background:none;border:none;cursor:pointer;color:#aaa;font-size:15px;padding:0 4px}
      #ss-cart-total-row{font-weight:700;font-size:14px;display:flex;justify-content:space-between;padding:10px 0;border-top:1px solid #eee;margin-bottom:12px;color:#0a0a0a}
      #ss-checkout input{width:100%;padding:10px 12px;border:1px solid #ddd;border-radius:8px;margin-bottom:8px;font-size:14px;font-family:inherit;box-sizing:border-box;color:#0a0a0a;background:#fff}
      #ss-checkout input::placeholder{color:#888}
      #ss-checkout input:focus{outline:none;border-color:#16a34a}
      #ss-pay{width:100%;padding:13px;border-radius:10px;border:none;background:#16a34a;color:#fff !important;font-weight:700;font-size:15px;cursor:pointer;font-family:inherit}
